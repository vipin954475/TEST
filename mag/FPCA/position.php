                        ...
                        <div class="row h-100 align-items-center justify-content-center">
                            ...
                            <div class="col-12 col-md-10 col-lg-6">
                                <div class="welcome-text text-center">
                                     <h2 data-animation="fadeInUpBig" data-delay="100ms">position in movie</h2>
                                    <div class="form-group">
                                    <form  method="post" action="position_action.php">
                                        <label>
                                    <input type="text" name="post" required placeholder="enter post" class="form-control">
                                    </label><br>
                                    
                                <label>
                                    <input type="submit" value="add" name="add"  class="btn razo-btn w-100">
