...
while($row = mysqli_fetch_assoc($rs))
{
   ...
   ECHO'
                    ...
                    <div class="featured-post-area bg-img bg-overlay mb-30" style="background-image: url(../profile/'.$row['profile'].');">
                            ...
                            <div class="post-overlay">
                                ...
                                <br>
                                <a href="" class="post-title">'.$row["moviename"].'</a><br>
                                 ';
    echo "<br><br><a  href='deleteartist.php?id=".$row['artistid']."' class='btn razo-btn' >Delete</a></div>
                        </div>";
                           }
                        ?>
</center>
  ...
  <script type="text/javascript">
          function approve_fn(id)
          {
               ...
               $("#del").attr("href","deleteartist.php?id="+id);
          }
</html>