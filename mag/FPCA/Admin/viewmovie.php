   ...
   ECHO' 
                        ...
                        <div width="100%" class="featured-post-area bg-img bg-overlay mb-30" style="background-image: url(../Movie/'.$row['Comments'].');">
                            ...
                            <div class="post-overlay">
                                <div class="post-meta">
                                    <a href="addcomment.php   "><i class="fa fa-comments-o" aria-hidden="true"></i>'.$row['count'].'</a>
                            ...
                            ';
                         echo "<br><br><a onclick='delete_fun(".$row['mid'].");'  href='#' class='btn razo-btn' >Delete</a></div>
                        </div>";
                    }
                        ?>
</center>
